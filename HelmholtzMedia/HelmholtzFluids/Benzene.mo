...
extends Interfaces.PartialHelmholtzMedium(
  ...
  fluidConstantsBenzene(
    ...
    hasCriticalData=true,
       ...
       //HCRIT0=550826.4101454036,//CoolProp
       HCRIT0=578357,//EOS calculation
       //SCRIT0=1166.3528638556643,//CoolProp
       SCRIT0=1215.42,//EOS calculation
  ...
  fluidLimitsBenzene(
    ...
    HMAX=+1.244e6,
    SMIN=-771,
    SMAX=3152.33) "Helmholtz EoS Limits";

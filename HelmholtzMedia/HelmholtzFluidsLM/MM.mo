...
extends Interfaces.PartialHelmholtzMedium(
  ...
  fluidLimitsMM(
    ...
    HMAX=+1300e3,
    SMIN=-682.903,
    SMAX=8849.05) "Helmholtz EoS Limits";
  ...
  dynamicViscosityCoefficientsMM(
    ...
    diluteModel=3,
    initialModel=0,
    nistCoeff={-0.413767,1.17675,-0.241401},
    corrL=30,
...
<p>The EOS: Thol-FPE-2016-MM,Thol-THESIS-2015 has convergence problems. Used the original one from Colonna 2006</p>

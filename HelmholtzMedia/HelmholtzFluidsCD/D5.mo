...
extends Interfaces.PartialHelmholtzMedium(
  ...
  fluidConstantsD5(
    ...
    hasCriticalData=true,
       ...
       HCRIT0=307081.228870031,//CoolProp OK
       SCRIT0=551.8871278161231,//CoolProp OK
  ...
  fluidLimitsD5(
    ...
    //DMAX=1049.28,//RefProp, but for Colonna 2006 EOS
    ...
    HMAX=384982,
    SMIN=-1455e3,
    SMAX=3859.66) "Helmholtz EoS Limits";
  ...
  dynamicViscosityCoefficientsD5(
    ...
    diluteModel=3,
    initialModel=0,
    nistCoeff={-2.49055,4.63356,-1.89292,0.247782},
    corrL=30,

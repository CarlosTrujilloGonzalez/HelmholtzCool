...
extends Interfaces.PartialHelmholtzMedium(
  ...
  fluidConstantsD4(
    ...
    hasCriticalData=true,
       ...
       HCRIT0=324035.4413346994,//CoolProp OK
       SCRIT0=618.3989903609627,//CoolProp OK
  ...
  fluidLimitsD4(
    ...
    //DMAX=952.13,//RefProp, but for Colonna 2006 EOS
    ...
    HMAX=1.93324e6,
    SMIN=-923.4,
    SMAX=6342.79) "Helmholtz EoS Limits";
  ...
  dynamicViscosityCoefficientsD4(
    ...
    diluteModel=3,
    initialModel=0,
    nistCoeff={2.42579,-0.871777,0.137283},
    corrL=30,

...
extends Interfaces.PartialHelmholtzMedium(
  ...
  fluidConstantsCarbonMonoxide(
    ...
    hasCriticalData=true,
       ...
       HCRIT0=164714,//EOS calculation
       //SCRIT0=1429.5311822789474,//CoolProp
       SCRIT0=1429.44,//EOS calculation
  ...
  fluidLimitsCarbonMonoxide(
    ...
    HMAX=687933,
    SMIN=-730.219,
    SMAX=45438.4) "Helmholtz EoS Limits";
  ...
  thermalConductivityCoefficientsCarbonMonoxide(
    ai={3.29558e-4,3.05976e-6,-3.13222e-9},
    corrG=120,
    coefG={5.9882E-04,6.863E-01,5.713E+01,5.0192E+02,0.0},
    diluteModel=9,
    nistCoeff={1.00037,-0.0082682},
    corrL=51,
